	...
	<c:forEach items="${postList}" var="post">
		...
		<div class="card border rounded mt-3">
			...
			<div class="card-like m-3">
				...
				<%-- <a class="likeBtn" href="like/like_click?postId=${post.id}"> --%>
				<a class="likeBtn" href="#" data-post-id="${post.id}">
			...
			<div class="card-post m-3">
				<span class="font-weight-bold">${post.userName} </span> <span> ${post.content}</span>
			</div>
